...
package com.sap.dirigible.ide.logging;
...
public class Logger {
	 ...
	 */
	// private Logger(org.apache.log4j.Logger delegate, java.util.logging.Logger
	// delegate2) {
	...
	private Logger(org.slf4j.Logger delegate3,
			java.util.logging.Logger delegate2) {
		// private Logger(java.util.logging.Logger delegate) {
