	...
	public void move(IPath destination, int updateFlags,
		...
		try {
			...
			try {
				...
				} else if (entity instanceof com.sap.dirigible.repository.api.IResource) {
					com.sap.dirigible.repository.api.IResource resource = (com.sap.dirigible.repository.api.IResource) entity;
