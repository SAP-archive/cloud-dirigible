 ...
 *******************************************************************************/
package com.sap.dirigible.ide.ui.rap.shared;
...
public interface LayoutSetConstants {
	 ...
	 * LayoutSet Ids
	 */
	public static final String SET_ID_CONFIG_DIALOG = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.configdialog"; //$NON-NLS-1$
	public static final String SET_ID_COOLBAR = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.coolbar"; //$NON-NLS-1$
	public static final String SET_ID_OVERFLOW = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.coolbaroverflow"; //$NON-NLS-1$
	public static final String SET_ID_FOOTER = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.footer"; //$NON-NLS-1$
	public static final String SET_ID_HEADER = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.header"; //$NON-NLS-1$
	public static final String SET_ID_LOGO = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.Logo"; //$NON-NLS-1$
	public static final String SET_ID_MENUBAR = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.menubar"; //$NON-NLS-1$
	public static final String SET_ID_PERSP = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.perspective"; //$NON-NLS-1$
	public static final String SET_ID_STACKPRESENTATION = "com.sap.dirigible.ide.ui.rap.layoutsets.fancy.stack"; //$NON-NLS-1$
