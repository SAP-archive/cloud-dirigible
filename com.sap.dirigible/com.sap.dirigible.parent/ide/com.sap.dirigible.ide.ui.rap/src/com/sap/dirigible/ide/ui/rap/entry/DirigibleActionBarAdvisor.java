...
public class DirigibleActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void makeActions(final IWorkbenchWindow window) {
		...
		dirigibleHomeAction.setId("com.sap.dirigible.ide.home"); //$NON-NLS-1$
		...
		dirigibleHelpAction.setId("com.sap.dirigible.ide.help"); //$NON-NLS-1$
		...
		dirigibleSamplesAction.setId("com.sap.dirigible.ide.samples"); //$NON-NLS-1$
		...
		dirigibleForumAction.setId("com.sap.dirigible.ide.forum"); //$NON-NLS-1$
		...
		aboutAction.setId("com.sap.dirigible.ide.about"); //$NON-NLS-1$
