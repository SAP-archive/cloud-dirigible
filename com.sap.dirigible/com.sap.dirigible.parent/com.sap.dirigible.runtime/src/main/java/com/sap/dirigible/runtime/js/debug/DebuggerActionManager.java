...
public class DebuggerActionManager {
	...
	private Map<String, DebuggerActionCommander> commanders = Collections.synchronizedMap(new HashMap<String, DebuggerActionCommander>());
	
	public static DebuggerActionManager getInstance(HttpSession session) {
		DebuggerActionManager debuggerActionManager = 
					(DebuggerActionManager) session.getAttribute(DEBUGGER_ACTION_MANAGER);
