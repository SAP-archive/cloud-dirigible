...
public abstract class AbstractRegistryServiceServlet extends AbstractRegistryServlet {
    ...
    private static final Logger log = LoggerFactory
            .getLogger(AbstractRegistryServiceServlet.class.getCanonicalName());
    ...
    protected void doGet(final HttpServletRequest request,
        ...
        try {
            ...
            buildList(new DefinitionEnumerator(repositoryPath, collection, getFileExtension()).toArrayList(), request,
                    response);
        } catch (final IllegalArgumentException ex) {
            log.error(String
                    .format(getRequestProcessingFailedMessage(), repositoryPath)
                    + ex.getMessage());
    ...
    private void buildList(final List<String> jsDefinitions,
