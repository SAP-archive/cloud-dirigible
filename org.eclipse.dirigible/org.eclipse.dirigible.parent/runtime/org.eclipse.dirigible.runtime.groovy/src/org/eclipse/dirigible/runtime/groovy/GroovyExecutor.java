...
public class GroovyExecutor extends AbstractScriptExecutor {
	...
	private static final String GROOVY_MODULE_NAME_CANNOT_BE_NULL = org.eclipse.dirigible.runtime.groovy.Messages.getString("GroovyExecutor.GROOVY_MODULE_NAME_CANNOT_BE_NULL");  //$NON-NLS-1$
